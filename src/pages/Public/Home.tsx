...
export const Home = () => {
  ...
  return (
    <div className="space-y-12">
      {/* Hero Section */}
      <section className="text-center space-y-6 py-12 bg-green-50 rounded-3xl px-4">
        ...
        <p className="text-lg text-green-700 max-w-2xl mx-auto">
          Ajukan layanan administrasi keagamaan dengan mudah melalui WhatsApp dan Website tanpa perlu datang ke kantor.
        </p>
        <div className="flex flex-col sm:flex-row justify-center gap-4 pt-4">
          ...
          <Button size="lg" variant="outline" className="text-green-700 border-green-600 hover:bg-green-50 text-lg" asChild>
            <a href="https://wa.me/628113656262?text=Halo%20Kemenag%20Jember,%20saya%20ingin%20mengajukan%20layanan" target="_blank" rel="noopener noreferrer">
        ...
        {loading ? (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map(service => (
              <Card key={service.id} className="hover:shadow-lg transition-shadow border-green-100">
                <CardHeader>
